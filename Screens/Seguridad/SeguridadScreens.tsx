...
const SeguridadScreens = () => {
  return (
    <View style={styles.container}>
        <CabeGComponent/>
        <View style={styles.caja_botones}>
            
            <CajaComponent children={undefined} titulo={'SEGURIDAD'}>
           <Image style={styles.caja_img}  source={require('../../assets/fondos/WhatsAppImage2024-01-19at12.19.59PM.jpeg')}/>
...
export default SeguridadScreens