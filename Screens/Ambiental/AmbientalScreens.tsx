  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.caja_botones}>
            ...
            <CajaComponent children={undefined} titulo={'AMBIENTE'}>
           <Image style={styles.caja_img}  source={require('../../assets/fondos/fondo_ambiental.jpeg')}/>
