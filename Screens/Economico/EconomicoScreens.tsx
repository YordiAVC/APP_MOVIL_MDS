...
const EconomicoScreens = () => {
  return (
    <View style={styles.container}>
        <CabeGComponent/>
        <View style={styles.caja_botones}>
        
            <CajaComponent children={undefined} titulo={'ECONOMICO'}>
           <Image style={styles.caja_img}  source={require('../../assets/fondos/Frame 54.jpg')}/>
...
export default EconomicoScreens;